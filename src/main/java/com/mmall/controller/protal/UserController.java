...
public class UserController {
    ...
    @ResponseBody
    public ServerResponse<String> resetPassword(HttpSession session,String passwordOle,String passwordNew){
        User user = (User)session.getAttribute(Const.CURRENT_USER);
        if(user == null ){
            return ServerResponse.createByErrorMessage("未登陆");
        }
        return userService.resetPassword(passwordOle,passwordNew,user);
    }
